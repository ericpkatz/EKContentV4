...
namespace EKContent.web.Controllers
{
    ...
    public class FileController : BaseController
    {
        ...
        {
            var model = new FileListViewModel{Files = _service.Dal.FileProvider.Get().ToList()};
        ...
        public ActionResult Create(FileCreateViewModel model)
        {
            ...
            _service.Dal.FileProvider.Set(model.File);
        ...
        public ActionResult Delete(int pageId, int id)
        {
            ...
            _service.Dal.FileProvider.Delete(file);
