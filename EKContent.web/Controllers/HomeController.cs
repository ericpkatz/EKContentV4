...
namespace EKContent.web.Controllers
{
    public class HomeController : BaseController
    {
            ...
            var model = new EditContentItemViewModel
                            {
                                ...
                                Files = _service.Dal.FileProvider.Get().ToList()
                            };
        ...
        public ActionResult EditContent(EditContentItemViewModel model)
        {
            ...
            model.Files = _service.Dal.FileProvider.Get().ToList();
        ...
        public ActionResult EditPage(EditPageViewModel model)
        {
            ...
            _service.SavePageNavigation(page);
            Message("Page Saved");
        ...
        public ActionResult DeletePage(int id)
        {
            ...
            pages.Remove(page);
            _service.Dal.PageNavigationProvider.Delete(page);
